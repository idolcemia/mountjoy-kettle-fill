...
lv_obj_t *uic_BSLogo;
lv_obj_t *ui_Screen1 = NULL;lv_obj_t *ui_Dropdown1 = NULL;lv_obj_t *ui_BSLogo = NULL;lv_obj_t *ui_SelectUserLabel = NULL;lv_obj_t *ui_ConfirmUserButton = NULL;lv_obj_t *ui_UserDisplayLabel = NULL;lv_obj_t *ui_ConfirmLabel1 = NULL;
// event funtions
